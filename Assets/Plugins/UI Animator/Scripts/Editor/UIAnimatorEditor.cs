...
namespace UIAnimatorCore
{
	...
	public class UIAnimatorEditor : Editor 
	{
		...
		protected GUIStyle CustomFoldoutStyle
		{
			get {
				if (m_customFoldoutStyle == null)
				{
					...
					m_customFoldoutStyle.fontStyle = FontStyle.BoldAndItalic;
					...
					m_customFoldoutStyle.contentOffset = new Vector2 (0,-2);
				}
		...
		private void DrawAutoPlayOptionMatrix()
		{
			...
			ActionMatrixData.OnInspectorGUI (serializedObject.FindProperty("m_onPointerClickAMD"), new GUIContent("OnPointerClick"));
