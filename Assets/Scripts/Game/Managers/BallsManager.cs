...
namespace RBGame
{
    ...
    public class BallsManager : GModel
    {
        ...
        public int GroupCount => cx.GroupManager.GroupCount; // DEPRECATED сколько групп
        public int TotalCount => cx.GroupManager.TotalCoins;// сколько всего шаров на уровне
        ...
        private void Start ()
        {
            cx.GroupManager.OnGroupCollected += OnGroupCollected;
        }
