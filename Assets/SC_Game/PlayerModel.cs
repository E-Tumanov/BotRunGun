...
namespace RBGame
{
    ...
    public interface IPlayerModel
    {
        ...
        void SetButton (bool isPressed);
        void SetLeftButton (bool isPressed);
        void SetRightButton (bool isPressed);
    ...
    {
        public Vector3 position => ppos;//0.5f * (ppos + prevPos);
        public float levelSpeed { get; private set; }
        public float wheelYaw { get; private set; }
        public float bodyRoll { get; private set; }
        public float stoppedPos { get; private set; }
        ...
        Vector3 fpos; // точка следует за ppos. Вектор наклона
        Vector3 ppos;
        Vector3 prevPos;
        bool isFreeze;
